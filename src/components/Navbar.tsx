      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            <img src={logo} alt="Kaveesha Engineers India Pvt. Ltd." className="h-10 w-auto object-contain transition-transform group-hover:scale-105" />
            <span className="hidden lg:block text-sm font-semibold gradient-text whitespace-nowrap">
